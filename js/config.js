...
var l_musicPlaylist = [
	...
	{youtube: "_tjznmbULIY", name: "X Song - 볼빨간사춘기"},
	...
	{youtube: "QslJYDX3o8s", name: "Red Velvet 레드벨벳 - 러시안 룰렛 (Russian Roulette)"},
	{youtube: "KsED9Gs4Lgg", name: "가인 (Gain) – Carnival"}
];
...
"신병 모집 때문에 오셨다면 부대원의 지시를 따라주시면 됩니다.",
"저희부대가 궁금하시다면 말씀해드리죠, 보트타는부ㄷ...퍽",
"로딩이 많이 오래걸리시죠? 조금만 기다리시면 됩니다ㅎㅎ",
"면접시 입대 동기를 묻게되니 생각 잘해보십시요. 재미있어서 왔다.. 그런건 킥입니다.",
"노래 좋은거 추천해주세요ㅎㅎ",
"우리부대는 다나까 말투 사용을 금지하고 있습니다.",
"다른부대 가보면 상황극이 아니라는데 보다 '사실적인' 상황극입니다, 군그룹은.",
"들어오시게 되면 부사관 후보생, 해군사관학교 생도로 지원 가능합니다.",
"우리부대는 물량보다 소수정예 부대입니다ㅎㅎ",
"으어엏엉헝허어어",
"서버 오픈시간은 금요일, 주말입니다. 시간은 내가 꼴리는대로..",
"환영합니다!!",
"안녕하세요!!"
];
